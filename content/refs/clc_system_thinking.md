...
> [!info]
> Systems thinking một quan điểm mà các tổ chức học tập hoặc còn gọi là [[refs/clc_continuous_learning|Continuous Learning Culture]], phát triển thông qua việc thành thạo bốn nguyên tắc: thành thạo cá nhân, mô hình tư duy, tầm nhìn chung và tổ chức học tập.
> Nó cho phép các tổ chức hiểu được các thành phần và mối liên kết của chúng.
...
* Tối ưu hoá Value Stream
  * [[refs/safe_value_stream|Value Stream]] bao gồm các hoạt động biến đổi ý tưởng kinh doanh thành các giải pháp cho khách hàng.
  * Cải tiến liên tục trên tất cả các nhóm và phòng ban là rất quan trọng, sử dụng các kỹ thuật như [[refs/safe_value_stream_mapping|Value Stream Mapping]] để hình dung và phân tích quy trình phát triển.
  * Việc tạo [[refs/safe_value_stream_mapping|Value Stream Mapping]] này giúp xác định các thực hành hiệu quả, các lĩnh vực cần thêm giá trị và những điều chỉnh cần thiết.
