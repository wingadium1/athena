...
2. **Chào đón các yêu cầu thay đổi**, ngay cả khi đã muộn trong quá trình phát triển. Các quy trình Agile tận dụng sự thay đổi để đạt được _lợi thế cạnh tranh của khách hàng_.\
...
7. **Phần mềm hoạt động** là thước đo chính của _tiến độ_.
...
9. **Liên tục chú ý** đến sự _hoàn thiện về kỹ thuật_ và _sử dụng các thiết kế tốt_, điều đó _tăng cường sự linh hoạt._
